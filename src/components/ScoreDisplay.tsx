...
const tierConfig = {
  High: {
    ...
    badgeBg: "bg-green-400/8 border-green-400/15 text-green-400",
  },
  Medium: {
    color: "hsl(25 100% 58%)",
    label: "Moderate Chance",
    badgeBg: "bg-primary/8 border-primary/15 text-primary",
  },
  Low: {
    color: "hsl(0 70% 56%)",
    label: "Needs Improvement",
    badgeBg: "bg-red-400/8 border-red-400/15 text-red-400",
  },
};
    ...
    >
      <div className="glass-card-elevated rounded-2xl p-8 md:p-10">
        <div className="flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="relative shrink-0">
            <svg width="140" height="140" viewBox="0 0 140 140" className="-rotate-90">
              {/* Background circle */}
              <circle cx="70" cy="70" r={radius} fill="none" stroke="hsl(230 15% 13%)" strokeWidth="6" />
              {/* Progress circle */}
              <motion.circle
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              ...
              <span className="text-muted-foreground/50 text-[11px] font-body mt-0.5">out of 100</span>
            </div>
          </div>
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-muted-foreground/50 text-[12px] font-body mt-3 leading-relaxed max-w-sm">
            ...
            <div className="flex items-center gap-4 mt-4 justify-center md:justify-start">
              {[
                ...
                >
                  <stat.icon className="w-3 h-3 text-muted-foreground/30" />
                  <span className="text-foreground/80 text-[12px] font-display font-medium">{stat.value}</span>
                  <span className="text-muted-foreground/30 text-[11px] font-body">{stat.label}</span>
                </motion.div>
              ))}
            </div>
          </div>
        ...
        <div className="mt-6 pt-5 border-t border-border/30 flex items-center justify-between">
          ...
          <span className="text-muted-foreground/25 text-[10px] font-body">
            Analyzed just now
          </span>
        </div>
      </div>
